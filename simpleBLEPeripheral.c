...
void SimpleBLEPeripheral_Init( uint8 task_id )
{
  ...
  #endif // HAL_IMAGE_A
#else
  HalLcdWriteString( "BLE Peripheral TEST", HAL_LCD_LINE_1 );
  ...
  // ª½±µ³]©wp0.0¬OÃþ¤ñ¿é¤J,±Nhal_adc.c¤¤enable and disable ADCCFGªºµ{§Ç²¾°£,Á×§KÂà´«
  ADCCFG |= 0x01;
 ...
 *          ¹ê»Ú¶q´ú4.235V ADCÂà´««áªº¼Æ­È¬°21 ¨C¶¡¶Z0.05V¤U­°1
 *          ¦]¦¹³]©w¤p©ó11(3.735v)®É¶}©l°{Ã{,·í¹qÀ£§C©ó8(3.585v)¥ð¯v
 *          ·í¹qÀ£§C©ó3.185v ADC¼Æ­È±N·|²§±`ÅÜ°ª,¦]¦¹§P©w¤j©ó21ª½±µ¥ð¯v
 *
 * @param   none
 *
 * @return  none
...
static void checkBattery(void)
{
	...
	// ¤Q¦¸ªº¥­§¡­È¤p©ó8©Î¤j©ó21¤~·|¯uªº¶i¤Jsleep
