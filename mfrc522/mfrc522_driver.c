...
/*
 * Function Name¡GWrite_MFRC5200
 * Function Description: To a certain MFRC522 register to write a byte of data
 * Input Parameters¡Gaddr - register address; val - the value to be written
 * Return value: None
 */
...
/*
 * Function Name¡GMFRC522_Request
